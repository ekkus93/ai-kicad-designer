"""Execute frozen corpus.v5 and preserve complete automated evidence."""
...
SPEC = importlib.util.spec_from_file_location(
    "m2f1_evaluate", ROOT / "fixtures/m2blind_v4/evaluate.py"
)
...
def freeze_audit() -> dict[str, object]:
    ...
    result = {
        ...
        "corpus_sha256": sha256(HERE / "corpus.v5.json"),
        "corpus_unchanged": sha256(HERE / "corpus.v5.json")
        == (HERE / "corpus.v5.sha256").read_text().split()[0],
...
def main() -> None:
    ...
    corpus = json.loads((HERE / "corpus.v5.json").read_text())
    ...
    results: dict[str, object] = {
        "schema_version": "m2g1.automated-results.v1",
    ...
    reproducibility: dict[str, object] = {
        "schema_version": "m2g1.reproducibility.v1",
        "cases": {},
    }
    for case_id in CASE_IDS:
        ...
        print(
            case_id,
            results["cases"][case_id]["automated_status"],
            failure_class or "",
            flush=True,
        )
