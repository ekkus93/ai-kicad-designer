"""Create the one-time M2g1 implementation/environment freeze before V5 authoring."""
...
def main() -> None:
    forbidden = [HERE / "corpus.v5.json", HERE / "ir"]
    if any(path.exists() for path in forbidden):
        raise SystemExit("refusing to freeze after V5 corpus/IR authoring")
    ...
    freeze = {
        "schema_version": "m2g1.implementation-freeze.v1",
